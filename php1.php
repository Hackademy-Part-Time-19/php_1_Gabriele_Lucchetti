...
$corsoHackademy = [
    ...
    "studente" => ["Gabriele", "Fabio", "Domenico"],
    "argomenti" => ["HTML,", "CSS,", "Bootstrap,", "JavaScript,", "PHP"],
];

echo "Sono" . " " . $corsoHackademy["studente"][0] . " e sto studiando ". $corsoHackademy["argomenti"][4] ." con ". $corsoHackademy["docenti"][1] 
." mentre prima ho imparato ". $corsoHackademy["argomenti"][0] ."". $corsoHackademy["argomenti"][1] ." ". $corsoHackademy["argomenti"][2] 
. " " . $corsoHackademy["argomenti"][3] ." con " . $corsoHackademy["docenti"][0];
